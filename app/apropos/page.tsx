export default function Apropos() {
  return (
    <div className="min-h-full flex flex-col items-center text-white">
      <div className="flex flex-col items-center  w-[80%] md:w-[40%]  h-full m-10 gap-5">
        <p className="font-helvatica text-3xl">À propos</p>
